...
class FeedbackParser:
    ...
    def parse(self, last_modified_date: Union[str, None]) -> Union[None, Tuple[datetime, pd.DataFrame]]:
        ...
        try:
            ...
            # либо если не получилось, предполагаем, что файла нет, или другая ошибка, поэтому
            # будем перезапивать заново. Для этого считаем, что выгрузили 1.1.1970 - максимально раннюю дату.
